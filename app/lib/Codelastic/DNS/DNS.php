...
class DNS {
	...
	*/
	 ...
	 * @return	array
	 */
	public static function searchDomain($keyword = '')
	{
		$client = SLSoapClient::getClient('SoftLayer_Dns_Domain', null, $this->userName, $this->apiKey);
	 ...
	 * @return	array
	 */
	public static function addDomain($domainName = '', $ip = '', $ttl = 86400)
	{
		$client =SLSoapClient::getClient('SoftLayer_Dns_Domain', null, $this->userName, $this->apiKey);
	 ...
	 * @return	array
	 */
	public static function removeDomain($domainId = 0, $domainName = '')
	{
		// Get domain id
		...
		$client = SLSoapClient::getClient('SoftLayer_Dns_Domain', $id, $this->userName, $this->apiKey);
	 ...
	 * @return	array
	 */
	public static function retrieveRecords($domainId = 0, $domainName = '')
	{
		// Get domain id
		$id = $this->getDomainId($domainId,$domainName);
	 ...
	 * @return	array
	 */
	public static function addRecord($domainId = 0, $domainName = '', $type = 'a', $host = '', $data = '', $ttl = 86400, $mxPriority = NULL )
	{
		// Get domain id
		$id = $this->getDomainId($domainId,$domainName);
	 ...
	 * @return	array
	 */
	public static function addSrvRecord($domainId = 0, $domainName = '', $host = '', $data = '', $protocol = 'TCP', $port = 0, $priority = 0, $service = '', $ttl = 86400)
	{
		...
		$client = SLSoapClient::getClient('SoftLayer_Dns_Domain_ResourceRecord_SrvType', NULL, $this->userName, $this->apiKey);
	 ...
	 * @return	array
	 */
	public static function removeRecord($recordId = 0)
	{
		if($recordId == 0)
		{
		...
		$client = SLSoapClient::getClient('SoftLayer_Dns_Domain_ResourceRecord', $recordId, $this->userName, $this->apiKey);
	 ...
	 * @return	array
	 */
	public static function editRecord($recordId = 0, $host = '', $data = '', $ttl = 86400, $mxPriority = NULL)
	{
		$client = SLSoapClient::getClient('SoftLayer_Dns_Domain_ResourceRecord', $recordId, $this->userName, $this->apiKey);
	 ...
	 * @return	array
	 */
	public static function editSrvRecord($recordId = 0, $host = '', $data = '', $protocol = 'TCP', $port = 0, $priority = 0, $service = '', $ttl = 86400)
	{
		$client = SLSoapClient::getClient('SoftLayer_Dns_Domain_ResourceRecord_SrvType', NULL, $this->userName, $this->apiKey);
